        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          >
            <p>
              ...
              <strong className="text-text-primary">Frontend Engineer</strong>{" "}
              yang memiliki kecintaan mendalam pada pembuatan desain antarmuka
              web interaktif yang modern dan fungsional. Perjalanan saya di
              dunia pemrograman dimulai dari ketertarikan sederhana bagaimana
              baris kode bisa menjelma menjadi karya visual yang interaktif di
              internet.
            </p>
            <p>
              Dengan bekal pendidikan Informatika dan pengalaman praktis selama
              lebih dari{" "}
              <strong className="text-text-primary">3 tahun</strong>, saya
              mengkhususkan diri dalam pengembangan SPA/PWA menggunakan
              ekosistem{" "}
              <strong className="text-indigo-600 dark:text-indigo-400">
                Next.js, React, TypeScript, dan Tailwind CSS
              </strong>
              .
            </p>
            <p>
              Bagi saya, menulis kode bukan sekadar tentang fungsionalitas,
              tetapi juga tentang seni menyusun arsitektur kode yang bersih,
              mudah dirawat, dan dioptimasi agar memuat secepat mungkin demi
