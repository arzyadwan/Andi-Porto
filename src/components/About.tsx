    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="flex flex-col mb-12">
          <span className="text-xs uppercase tracking-widest text-indigo-500 dark:text-indigo-400 font-semibold mb-2">Tentang Saya</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 space-y-6 text-text-secondary leading-relaxed text-sm sm:text-base">
            <p>
              Halo! Saya adalah seorang <strong className="text-text-primary">Frontend Engineer</strong> yang memiliki kecintaan mendalam pada pembuatan desain antarmuka web interaktif yang modern dan fungsional. Perjalanan saya di dunia pemrograman dimulai dari ketertarikan sederhana bagaimana baris kode bisa menjelma menjadi karya visual yang interaktif di internet.
            </p>
            <p>
              Dengan bekal pendidikan Informatika dan pengalaman praktis selama lebih dari <strong className="text-text-primary">3 tahun</strong>, saya mengkhususkan diri dalam pengembangan SPA/PWA menggunakan ekosistem <strong className="text-indigo-600 dark:text-indigo-400">Next.js, React, TypeScript, dan Tailwind CSS</strong>.
            </p>
            <p>
          ...
          <div className="md:col-span-5 grid grid-cols-1 gap-6">
            {personalInfo.stats.map((stat, i) => {
              ...
              return (
                <div
                  key={i}
                  className="glass-effect p-6 rounded-2xl border border-slate-200 dark:border-slate-800/40 flex items-center gap-6 hover:border-indigo-500/40 hover:bg-slate-200/40 dark:hover:bg-slate-900/40 transition-all duration-300 group transform hover:-translate-y-1"
                >
                  ...
                  <div>
                    <h3 className="font-heading font-extrabold text-3xl sm:text-4xl text-text-primary tracking-tight">
                      {stat.value}
                    </h3>
                    <p className="text-xs text-text-secondary uppercase tracking-wider font-semibold mt-1">
                      {stat.label}
                    </p>
                  </div>
                </div>
